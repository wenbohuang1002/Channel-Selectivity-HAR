...
class Net_SC(nn.Module):
    def __init__(self):
            ...
            self.Block2 = nn.Sequential(
                SelectiveConv2d(in_channels=128, out_channels=256, kernel_size=(6, 1), stride=(2, 1), padding=(0, 0),
            ...
            self.Block3 = nn.Sequential(
                SelectiveConv2d(in_channels=256, out_channels=384, kernel_size=(6, 2), stride=(2, 1), padding=(0, 0),
                                dropout_rate=0.1, gamma=0.0001, K=16, N_max=32),
                nn.BatchNorm2d(384),
                nn.ReLU(True),
...
print(cm)
# np.save('Store/Wisdm_R/confusion_matrix_resc.npy',cm)
