...
print(cm)
# np.save('Store/Opportunity_R/confusion_matrix_reb.npy',cm)
# np.save('Store/Opportunity_R/epoch_reb.npy',epoch_list)
# np.save('Store/Opportunity_R/accuracy_reb.npy',accuracy_list)
# np.save('Store/Opportunity_R/loss_reb.npy',loss_list)
model = Net_SC()
stat(model, (64, 107, 1))
