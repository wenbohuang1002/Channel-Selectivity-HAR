...
# np.save('Store/Unimib_R1/epoch_baseline.npy',epoch_list)
# np.save('Store/Unimib_R1/accuracy_baseline.npy',accuracy_list)
# np.save('Store/Unimib_R1/loss_baseline.npy',loss_list)