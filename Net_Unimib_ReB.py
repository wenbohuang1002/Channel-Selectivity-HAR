...
print(cm)
np.save('Store/Unimib_R/confusion_matrix_reb.npy',cm)
# np.save('Store/Unimib_R/epoch_reb.npy',epoch_list)
# np.save('Store/Unimib_R/accuracy_reb.npy',accuracy_list)
# np.save('Store/Unimib_R/loss_reb.npy',loss_list)
