...
print(cm)
np.save('Store/Pamap2_R/confusion_matrix_reb.npy',cm)
np.save('Store/Pamap2_R/epoch_reb.npy',epoch_list)
np.save('Store/Pamap2_R/accuracy_reb.npy',accuracy_list)
np.save('Store/Pamap2_R/loss_reb.npy',loss_list)
