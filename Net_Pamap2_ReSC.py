    ...
    def __init__(self):
            ...
            self.Block1 = nn.Sequential(
                ...
                SelectiveConv2d(in_channels=128, out_channels=128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1),
                                dropout_rate=0.1, gamma=0.0005, K=32, N_max=32),
                nn.BatchNorm2d(128),
                nn.ReLU(True)
            )
...
# print(cm)
# np.save('Store/Pamap2_R/confusion_matrix_resc.npy',cm)
np.save('Store/Pamap2_R/epoch_resc2.npy',epoch_list)
np.save('Store/Pamap2_R/accuracy_resc2.npy',accuracy_list)
np.save('Store/Pamap2_R/loss_resc2.npy',loss_list)
