...
print(cm)
# np.save('Store/Opportunity_R/confusion_matrix_resc.npy',cm)
# np.save('Store/Opportunity_R/epoch_resc.npy',epoch_list)
# np.save('Store/Opportunity_R/accuracy_resc.npy',accuracy_list)
# np.save('Store/Opportunity_R/loss_resc.npy',loss_list)
