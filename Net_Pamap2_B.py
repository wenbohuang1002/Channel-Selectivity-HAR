...
np.save('Store/Pamap2_R/epoch_baseline.npy',epoch_list)
np.save('Store/Pamap2_R/accuracy_baseline.npy',accuracy_list)
np.save('Store/Pamap2_R/loss_baseline.npy',loss_list)
