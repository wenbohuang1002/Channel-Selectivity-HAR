...
class Net_SC(nn.Module):
    def __init__(self):
        ...
        # if message in ['y', 'Y']:
            ...
            # self.layer4 = nn.Sequential(
            #     SelectiveConv2d(in_channels=256, out_channels=256, kernel_size=(6, 1), stride=(3, 1), padding=(1, 0),
            #                     dropout_rate=0.01, gamma=0.001, K=32, N_max=32),
            #     nn.BatchNorm2d(256),
            #     nn.ReLU(True),
            # )
            # # self.ca4 = ChannelAttention(256)
            ...
            #                     dropout_rate=0.01, gamma=0.001, K=48, N_max=48),
            #     nn.BatchNorm2d(384),
            #     nn.ReLU(True),
            # )
            # self.ca6 = ChannelAttention(384)
...
print(cm)
np.save('Store/Unimib_R1/confusion_matrix_sc.npy',cm)
np.save('Store/Unimib_R1/epoch_sc.npy',epoch_list)
np.save('Store/Unimib_R1/accuracy_sc.npy',accuracy_list)
np.save('Store/Unimib_R1/loss_sc.npy',loss_list)
